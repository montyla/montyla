# Rascunho de Coleção de Cartas - Bônus de Conta

Objetivo: transformar cartas entregues em progresso permanente de conta sem deixar nenhuma classe excessivamente forte. A carta entregue é consumida e o bônus vale para todos os personagens da conta.
...
| Pontos de coleção | Bônus real sugerido | Limite por conta |
| --- | --- | --- |
| HP de Conta | a cada 1 ponto: HP máximo +10 | +1.500 HP |
| SP de Conta | a cada 1 ponto: SP máximo +3 | +300 SP |
| ATQ de Conta | a cada 10 pontos: ATQ +1 | +25 ATQ |
| ATQM de Conta | a cada 10 pontos: ATQM +1 | +25 ATQM |
| Precisão de Conta | a cada 5 pontos: Precisão +1 | +20 Precisão |
| Esquiva de Conta | a cada 5 pontos: Esquiva +1 | +20 Esquiva |
...
| --- | --- |
| Carta de Acidus | +1 ponto de HP de Conta |
| Carta de Acidus Azul | +1 ponto de HP de Conta |
| Carta de Agav | +1 ponto de SP de Conta |
| Carta de Agressor | +1 ponto de Crítico de Conta |
| Carta de Alarme | +1 ponto de HP de Conta |
| Carta de Alice | +1 ponto de Defesa de Conta |
| Carta de Alicel | +1 ponto de Defesa de Conta |
...
| Carta de Andarilho | +1 ponto de Esquiva de Conta |
...
| Carta de Apocalipse | +1 ponto de HP de Conta |
| Carta de Aqua Elemental | +1 ponto de Defesa de Conta |
| Carta de Aquecedor | +1 ponto de Esquiva de Conta |
| Carta de Aranha Gigante | +1 ponto de Resistência a Estados de Conta |
| Carta de Archdam | +1 ponto de ATQM de Conta |
| Carta de Arclouse | +1 ponto de Defesa de Conta |
...
| Carta de Bafomé Jr. | +1 ponto de ATQ de Conta |
| Carta de Banshee | +1 ponto de ATQM de Conta |
| Carta de Banshee Master | +1 ponto de ATQM de Conta |
| Carta de Batedor | +1 ponto de Defesa de Conta |
| Carta de Bathory | +1 ponto de Defesa de Conta |
| Carta de Bebe de Lobo do Deserto | +1 ponto de ATQ de Conta |
| Carta de Bebê Orc | +1 ponto de HP de Conta |
| Carta de Bebê Selvagem | +1 ponto de Resistência a Estados de Conta |
| Carta de Beholder | +1 ponto de Esquiva de Conta |
| Carta de Besouro-chifre | +1 ponto de Precisão de Conta |
| Carta de Besouro-ladrão | +1 ponto de Esquiva de Conta |
| Carta de Besouro-ladrão Fêmea | +1 ponto de Esquiva de Conta |
| Carta de Besouro-ladrão Macho | +1 ponto de Esquiva de Conta |
| Carta de Besouro-Rei | +1 ponto de SP de Conta |
| Carta de Bode | +1 ponto de Defesa de Conta |
| Carta de Boneca de Miyabi | +1 ponto de SP de Conta |
...
| Carta de Carniçal | +1 ponto de Resistência a Estados de Conta |
| Carta de Cavaleiro do Abismo | +1 ponto de ATQ de Conta |
| Carta de Cavalo-marinho | +1 ponto de Resistência a Estados de Conta |
| Carta de Cecil Damon | +1 ponto de Precisão de Conta |
| Carta de Centipede | +1 ponto de Defesa de Conta |
| Carta de Centipede Larva | +1 ponto de ATQM de Conta |
| Carta de Chepet | +1 ponto de ATQM de Conta |
| Carta de Choco | +1 ponto de Esquiva de Conta |
| Carta de Chonchon | +1 ponto de Esquiva de Conta |
| Carta de Chonchon de Aço | +1 ponto de Esquiva de Conta |
...
| Carta de Crânio Flamejante | +1 ponto de Resistência a Estados de Conta |
| Carta de Creamy | +1 ponto de Esquiva de Conta |
| Carta de Creamy Ameaçador | +1 ponto de Esquiva de Conta |
| Carta de Crocodilo | +1 ponto de Precisão de Conta |
| Carta de Dark Shadow | +1 ponto de Defesa de Conta |
...
| Carta de Dullahan | +1 ponto de Crítico de Conta |
| Carta de Echio | +1 ponto de HP de Conta |
...
| Carta de Filhote de Leopardo | +1 ponto de Defesa de Conta |
| Carta de Flora | +1 ponto de ATQ de Conta |
| Carta de Foca | +1 ponto de Precisão de Conta |
| Carta de Fornalha Velha | +1 ponto de ATQM de Conta |
| Carta de Frilldora | +1 ponto de Atributo Flexível de Conta |
...
| Carta de Giro-Goblin | +1 ponto de Crítico de Conta |
| Carta de Goblin a vapor | +1 ponto de Crítico de Conta |
| Carta de Goblin Arqueiro | +1 ponto de Precisão de Conta |
| Carta de Goblin de Adaga | +1 ponto de ATQ de Conta |
| Carta de Goblin Líder | +1 ponto de ATQ de Conta |
| Carta de Golem | +1 ponto de Defesa de Conta |
| Carta de Golem de Lava | +1 ponto de ATQ de Conta |
| Carta de Golem de Madeira | +1 ponto de HP de Conta |
...
| Carta de Hode | +1 ponto de Defesa de Conta |
| Carta de Hodremlin | +1 ponto de Defesa de Conta |
| Carta de Holden | +1 ponto de Crítico de Conta |
| Carta de Horong | +1 ponto de Atributo Flexível de Conta |
| Carta de Howard Alt-Eisen | +1 ponto de ATQ de Conta |
| Carta de Imp | +1 ponto de ATQM de Conta |
| Carta de Incubus | +1 ponto de SP de Conta |
| Carta de Injustiçado | +1 ponto de Atributo Flexível de Conta |
| Carta de Isilla | +1 ponto de ATQM de Conta |
...
| Carta de Karakasa | +1 ponto de Resistência a Estados de Conta |
...
| Carta de Lunático | +1 ponto de Esquiva de Conta |
| Carta de Magmaring | +1 ponto de Crítico de Conta |
| Carta de Magnólia | +1 ponto de Resistência a Estados de Conta |
| Carta de Majouros | +1 ponto de Resistência a Estados de Conta |
| Carta de Mandrágora | +1 ponto de ATQ de Conta |
| Carta de Mantis Assassino | +1 ponto de Resistência a Estados de Conta |
...
| Carta de Martin | +1 ponto de Resistência a Estados de Conta |
| Carta de Mascarado | +1 ponto de Resistência a Estados de Conta |
| Carta de Matyr | +1 ponto de HP de Conta |
| Carta de Medusa | +1 ponto de Resistência a Estados de Conta |
| Carta de Megalith | +1 ponto de Defesa de Conta |
| Carta de Megalodon | +1 ponto de Resistência a Estados de Conta |
...
| Carta de Minorous | +1 ponto de ATQ de Conta |
| Carta de Moldura Maldita | +1 ponto de Resistência a Estados de Conta |
| Carta de Molusco | +1 ponto de ATQ de Conta |
| Carta de Mosca Caçadora | +1 ponto de HP de Conta |
| Carta de Muka | +1 ponto de HP de Conta |
| Carta de Múmia | +1 ponto de Precisão de Conta |
| Carta de Múmia Anciã | +1 ponto de Atributo Flexível de Conta |
| Carta de Munak | +1 ponto de Resistência a Estados de Conta |
| Carta de Muscipular | +1 ponto de Esquiva de Conta |
| Carta de Nereida | +1 ponto de SP de Conta |
| Carta de Névoa | +1 ponto de Defesa de Conta |
| Carta de Ninfa Perversa | +1 ponto de SP de Conta |
| Carta de Nove Caudas | +1 ponto de Esquiva de Conta |
| Carta de Novus | +1 ponto de HP de Conta |
| Carta de Novus | +1 ponto de Resistência a Estados de Conta |
| Carta de Nuvem Tóxica | +1 ponto de Defesa de Conta |
| Carta de Nuvem Venenosa | +1 ponto de Resistência a Estados de Conta |
| Carta de Obeaune | +1 ponto de Atributo Flexível de Conta |
| Carta de Obsidiana | +1 ponto de Precisão de Conta |
| Carta de Orc Arqueiro | +1 ponto de HP de Conta |
| Carta de Orc Esqueleto | +1 ponto de HP de Conta |
...
| Carta de Papel | +1 ponto de SP de Conta |
| Carta de Parasita | +1 ponto de Defesa de Conta |
| Carta de Pasana | +1 ponto de Defesa de Conta |
| Carta de Pé-Grande | +1 ponto de Defesa de Conta |
| Carta de Peco Peco | +1 ponto de HP de Conta |
| Carta de Peixe-espada | +1 ponto de Defesa de Conta |
| Carta de Penomena | +1 ponto de Defesa de Conta |
| Carta de Percevejo | +1 ponto de Resistência a Estados de Conta |
| Carta de Pesadelo | +1 ponto de Resistência a Estados de Conta |
| Carta de Pesadelo Sombrio | +1 ponto de Resistência a Estados de Conta |
| Carta de Pessegueira Encantada | +1 ponto de Atributo Flexível de Conta |
| Carta de Peste | +1 ponto de Resistência a Estados de Conta |
| Carta de Petite Terrestre | +1 ponto de ATQ de Conta |
| Carta de Petite Voador | +1 ponto de Defesa de Conta |
...
| Carta de Poporing | +1 ponto de ATQM de Conta |
...
| Carta de Quve | +1 ponto de Esquiva de Conta |
| Carta de Rabo de verme | +1 ponto de Precisão de Conta |
| Carta de Rafflesia | +1 ponto de Defesa de Conta |
| Carta de Raggler | +1 ponto de ATQ de Conta |
| Carta de Raydric | +1 ponto de Defesa de Conta |
| Carta de Raydric Arqueiro | +1 ponto de Precisão de Conta |
...
| Carta de Rybio | +1 ponto de Resistência a Estados de Conta |
| Carta de Salgueiro | +1 ponto de SP de Conta |
| Carta de Salgueiro Ancião | +1 ponto de SP de Conta |
| Carta de Sapo de Rodda | +1 ponto de HP de Conta |
| Carta de Sapo de Thara | +1 ponto de Defesa de Conta |
| Carta de Sapo Venenoso | +1 ponto de Atributo Flexível de Conta |
| Carta de Sasquatch | +1 ponto de Resistência a Estados de Conta |
| Carta de Seeker | +1 ponto de Resistência a Estados de Conta |
| Carta de Selvagem | +1 ponto de Atributo Flexível de Conta |
| Carta de Senhora Orc | +1 ponto de HP de Conta |
| Carta de Serial Killer | +1 ponto de Crítico de Conta |
| Carta de Seyren Windsor | +1 ponto de ATQ de Conta |
| Carta de Shinobi | +1 ponto de Esquiva de Conta |
| Carta de Siroma | +1 ponto de ATQM de Conta |
| Carta de Skogul | +1 ponto de Resistência a Estados de Conta |
| Carta de Sohee | +1 ponto de SP de Conta |
| Carta de Soldadinho de Chumbo | +1 ponto de Crítico de Conta |
| Carta de Soldado | +1 ponto de Crítico de Conta |
| Carta de Soldado Atirador | +1 ponto de Precisão de Conta |
| Carta de Sorrateiro | +1 ponto de ATQ de Conta |
| Carta de Stapo | +1 ponto de Atributo Flexível de Conta |
| Carta de Sting | +1 ponto de Defesa de Conta |
...
| Carta de Ungoliant | +1 ponto de Resistência a Estados de Conta |
| Carta de Ursinho | +1 ponto de Defesa de Conta |
| Carta de Vadon | +1 ponto de ATQ de Conta |
| Carta de Vanberk | +1 ponto de Crítico de Conta |
...
| Carta de Zenorc | +1 ponto de HP de Conta |
| Carta de Zerom | +1 ponto de Precisão de Conta |
| Carta de Zhu Po Long | +1 ponto de Esquiva de Conta |
| Carta de Zipper | +1 ponto de SP de Conta |
| Carta de Zumbi | +1 ponto de HP de Conta |
| Carta de Zumbi Atirador | +1 ponto de HP de Conta |
| Carta de Zumbi Dilacerado | +1 ponto de HP de Conta |
| Carta de Zumbi Mestre | +1 ponto de HP de Conta |
| Carta de Zumbi Prisioneiro | +1 ponto de HP de Conta |
...
| Carta de Dama da Guarda | +2 pontos de Precisão de Conta |
| Carta de Dark Priest | +2 pontos de Defesa de Conta |
| Carta de Despero de Thanatos | +2 pontos de ATQM de Conta |
| Carta de Deviling | +2 pontos de Defesa de Conta |
| Carta de Dragão Mutante | +2 pontos de ATQ de Conta |
| Carta de Duque Coruja | +2 pontos de Atributo Flexível de Conta |
| Carta de Eclipse | +2 pontos de Atributo Flexível de Conta |
| Carta de Entweihen Crothen | +2 pontos de ATQM de Conta |
| Carta de Executora | +2 pontos de Defesa de Conta |
| Carta de Galion | +2 pontos de Precisão de Conta |
| Carta de Gato de Nove Caudas | +2 pontos de Defesa de Conta |
| Carta de Gemini-S58 | +2 pontos de Resistência a Estados de Conta |
| Carta de Ghostring | +2 pontos de HP de Conta |
| Carta de Grifo | +2 pontos de Crítico de Conta |
| Carta de Hidrolancer | +2 pontos de ATQ de Conta |
| Carta de Ilusão das Trevas | +2 pontos de HP de Conta |
| Carta de Kasa | +2 pontos de ATQ de Conta |
| Carta de Lady Solace | +2 pontos de ATQ de Conta |
| Carta de Libélula | +2 pontos de Esquiva de Conta |
| Carta de Lobo Errante | +2 pontos de ATQ de Conta |
| Carta de Maero de Thanatos | +2 pontos de Esquiva de Conta |
| Carta de Mastering | +2 pontos de Crítico de Conta |
| Carta de Maya Macho | +2 pontos de ATQM de Conta |
| Carta de Mysteltainn | +2 pontos de Defesa de Conta |
| Carta de Necromancer | +2 pontos de ATQM de Conta |
| Carta de Odium of Thanatos | +2 pontos de Esquiva de Conta |
| Carta de Pesar de Thanatos | +2 pontos de ATQM de Conta |
| Carta de Quimera | +2 pontos de Defesa de Conta |
| Carta de Salamandra | +2 pontos de Atributo Flexível de Conta |
| Carta de Sapo-Cururu | +2 pontos de Esquiva de Conta |
| Carta de Senhora do Abrigo | +2 pontos de ATQM de Conta |
| Carta de Skeggiold | +2 pontos de ATQM de Conta |
| Carta de Sword Master | +2 pontos de Precisão de Conta |
| Carta de Tirfing | +2 pontos de Defesa de Conta |

### Cartas MVP (44)

| Carta | Bônus ao entregar |
| --- | --- |
| Carta de Abelha-rainha | +3 pontos de SP de Conta |
| Carta de Algoz Eremes | +3 pontos de Atributo Flexível de Conta |
| Carta de Amon Ra | +3 pontos de ATQM de Conta |
| Carta de Arquimaga Kathryne | +3 pontos de ATQM de Conta |
| Carta de Atiradora-de-elite Cecil | +3 pontos de Precisão de Conta |
| Carta de Atroce | +3 pontos de ATQ de Conta |
| Carta de Bafomé | +3 pontos de ATQ de Conta |
| Carta de Belzebu | +3 pontos de ATQM de Conta |
| Carta de Besouro-ladrão Dourado | +3 pontos de SP de Conta |
| Carta de Bispo Decadente | +3 pontos de ATQM de Conta |
| Carta de Cavaleiro da Tempestade | +3 pontos de ATQ de Conta |
| Carta de Detardeurus | +3 pontos de Resistência a Estados de Conta |
| Carta de Doppelganger | +3 pontos de Esquiva de Conta |
| Carta de Drácula | +3 pontos de SP de Conta |
| Carta de Drake | +3 pontos de Defesa de Conta |
| Carta de Eddga | +3 pontos de HP de Conta |
| Carta de Egnigem Cenia | +3 pontos de HP de Conta |
| Carta de Faraó | +3 pontos de SP de Conta |
| Carta de Flor do Luar | +3 pontos de Esquiva de Conta |
| Carta de Freeoni | +3 pontos de Precisão de Conta |
| Carta de General Tartaruga | +3 pontos de ATQ de Conta |
| Carta de Hatii | +3 pontos de Resistência a Estados de Conta |
| Carta de Ifrit | +3 pontos de ATQ de Conta |
...
| Carta de Mestre-ferreiro Howard | +3 pontos de ATQ de Conta |
| Carta de Orc Hero | +3 pontos de HP de Conta |
| Carta de Osíris | +3 pontos de HP de Conta |
| Carta de Pesar Noturno | +3 pontos de ATQ de Conta |
| Carta de RSX-0806 | +3 pontos de Defesa de Conta |
| Carta de Sacerdotisa Margaretha | +3 pontos de Atributo Flexível de Conta |
| Carta de Samurai Encarnado | +3 pontos de ATQ de Conta |
| Carta de Senhor das Trevas | +3 pontos de Atributo Flexível de Conta |
| Carta de Senhor dos Mortos | +3 pontos de Resistência a Estados de Conta |
| Carta de Senhor dos Orcs | +3 pontos de HP de Conta |
| Carta de Serpente Suprema | +3 pontos de Resistência a Estados de Conta |
| Carta de Tao Gunka | +3 pontos de HP de Conta |
| Carta de Valkyrie Randgris | +3 pontos de Defesa de Conta |
| Carta de Vesper | +3 pontos de ATQM de Conta |
